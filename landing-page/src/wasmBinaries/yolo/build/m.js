...
const ModelPoseFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_modelpose_free(ptr >>> 0));
/**
*/
export class ModelPose {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        ModelPoseFinalization.unregister(this);
        return ptr;
    }
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_9d617ab4d2e503f0 = function(arg0, arg1) {
